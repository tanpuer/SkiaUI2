...
void ViewManager::registerHYViews() {
    this->runtime->enterContext([this](v8::Isolate *isolate, v8::Local<v8::Object> skiaUI) {
        ...
        auto viewTemplate = this->registerHYView(isolate, skiaUI, external);
        auto viewGroupTemplate = this->registerHYViewGroup(isolate, skiaUI, viewTemplate, external);
        auto flexboxTemplate = this->registerHYFlexboxLayout(isolate, skiaUI, viewGroupTemplate,
                                                             external);
        this->registerScrollView(isolate, skiaUI, flexboxTemplate, external);
        this->registerHYLottieView(isolate, skiaUI, viewTemplate, external);
        this->registerHYShaderView(isolate, skiaUI, viewTemplate, external);
    });
}
...
ViewManager::registerHYView(v8::Isolate *isolate, v8::Local<v8::Object> skiaUI,
...
v8::Local<v8::FunctionTemplate>
ViewManager::registerHYViewGroup(v8::Isolate *isolate, v8::Local<v8::Object> skiaUI,
...
v8::Local<v8::FunctionTemplate>
ViewManager::registerHYFlexboxLayout(v8::Isolate *isolate, v8::Local<v8::Object> skiaUI,
                                     v8::Local<v8::FunctionTemplate> inherit,
                                     v8::Local<v8::External> external) {
...
v8::Local<v8::FunctionTemplate>
ViewManager::registerScrollView(v8::Isolate *isolate, v8::Local<v8::Object> skiaUI,
                                v8::Local<v8::FunctionTemplate> inherit,
                                v8::Local<v8::External> external) {
...
v8::Local<v8::FunctionTemplate>
ViewManager::registerHYLottieView(v8::Isolate *isolate, v8::Local<v8::Object> skiaUI,
                                  v8::Local<v8::FunctionTemplate> inherit,
                                  v8::Local<v8::External> external) {
...
v8::Local<v8::FunctionTemplate>
ViewManager::registerHYShaderView(v8::Isolate *isolate, v8::Local<v8::Object> skiaUI,
                                  v8::Local<v8::FunctionTemplate> inherit,
                                  v8::Local<v8::External> external) {
