...
;// ./src/MusicApp.js
const{LinearAnimator}=SkiaUI;class MusicApp extends react.Component{constructor(props){super(props);console.log(TAG,"prop is:",JSON.stringify(props));this.innerWidth=SkiaUI?SkiaUI.innerWidth:1920;this.innerHeight=SkiaUI?SkiaUI.innerHeight:1080;this.svgRef=/*#__PURE__*/react.createRef();this.svgRotateAnimator=undefined;this.state={svgRotateZ:0};}componentDidMount(){console.log(TAG,"componentDidMount");if(!this.svgRotateAnimator&&this.svgRef.current!=null){this.svgRotateAnimator=new LinearAnimator(this.svgRef.current,0.0,360.0);this.svgRotateAnimator.duration=5000;this.svgRotateAnimator.loop=-1;this.svgRotateAnimator.setUpdateListener(value=>{this.setState({svgRotateZ:value});});this.svgRotateAnimator.start();}}componentWillUnmount(){console.log(TAG,"componentWillUnmount");}render(){return/*#__PURE__*/(0,jsx_runtime.jsx)("page",{style:{width:this.innerWidth,height:this.innerHeight},onCreate:()=>{console.log("MusicApp onCreate");},onDestroy:()=>{console.log("MusicApp onDestroy");},onShow:()=>{console.log("MusicApp onShow");},onHide:()=>{console.log("MusicApp onHide");},children:/*#__PURE__*/(0,jsx_runtime.jsxs)("scroll",{style:{flex:1,flexDirection:'column',flexWrap:'nowrap',justifyContent:'flex-start',alignItems:'center'},children:[/*#__PURE__*/(0,jsx_runtime.jsx)("text",{style:{textColor:"#00ff00",textSize:50},text:"Music App developed by React"}),/*#__PURE__*/(0,jsx_runtime.jsx)("svg",{ref:this.svgRef,style:{width:300,height:300,rotateZ:this.state.svgRotateZ},src:"react.svg"})]})});}}
;// ./src/SkiaApp.js
...
function WrapperComponent(_ref){let{component:Component}=_ref;const location=useLocation();const navigate=useNavigate();return/*#__PURE__*/(0,jsx_runtime.jsx)(Component,{...location,navigate:navigate});}SkiaUIRenderer_default().render(/*#__PURE__*/(0,jsx_runtime.jsx)(SkiaApp,{}));// SkiaUIRenderer.render(
...
/******/ })()
;
//# sourceMappingURL=main.5401e007.js.map