...
function comparePrevStylesAndNextStyles(view, prevStyles, nextStyles) {
...
function convertViewProps(view, props) {
  if (props.onClick) {
...
function convertSVGProps(svg, props) {
  if (props.src) {
    svg.src = props.src;
  }
  convertViewProps(svg, props);
}
function convertVideoProps(video, props) {
  if (props.url) {
    video.src = props.url;
  }
  convertViewProps(video, props);
}
function convertButtonProps(button, props) {
  if (props.text) {
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_page, { style: { "width": "1080px", "height": "1920px" } }, {
    default: withCtx(() => [
      createVNode(_component_scroll, { style: { "width": "1080px", "height": "1920px", "justify-content": "center", "align-items": "center" } }, {
        default: withCtx(() => [
...
const Music = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1]]);
const _sfc_main = {
  data() {
    return {
      viewBg: "#ffff00ff"
...
const _hoisted_1 = {
  style: { "width": "226px", "height": "227px", "margin-bottom": "50px" },
  src: "vue.svg"
};
      ...
      createVNode(_component_scroll, { style: { "width": "1080px", "height": "1920px", "justify-content": "center", "align-items": "center" } }, {
        default: withCtx(() => [
          createBaseVNode("view", {
            style: normalizeStyle({ width: "150px", height: "150px", marginBottom: "50px", "background-color": $data.viewBg }),
            onClick: _cache[0] || (_cache[0] = (...args) => $options.handleClick && $options.handleClick(...args))
          }, null, 4),
          (openBlock(), createElementBlock("svg", _hoisted_1)),
          _cache[2] || (_cache[2] = createBaseVNode("video", {
            style: { "width": "1080px", "height": "607px" },
            url: "yiluxiangbei.mp4"
          }, null, -1)),
          createBaseVNode("button", {
