...
class PageAllocator {
 public:
  ...
  // <AliOS> changed: begin
  virtual void* AllocatePages(void* address, size_t length, size_t alignment,
                              Permission permissions, const char* name) {
    return AllocatePages(address, length, alignment, permissions);
  }
  virtual bool SetPermissions(void* address, size_t length,
                              Permission permissions, const char* name) {
...
// <ALIOS> adapt for webengin 5.7: end
  ...
  virtual TracingController* GetTracingController() {
    static DefalutTracingController* defalut_tracing_controller_
        = new DefalutTracingController(this);
