...
class V8_EXPORT AllocationProfile {
 public:
  ...
  /**
   * Prepare a serialized representation of the allocation profile. The
   * result is written into the stream provided in chunks of specified size.
   *
   * For the JSON format, heap contents are represented as an object
   * {
   *   "head": {
   ...
   *                 "lineNumber": 0,
   *                 "scriptId": "176",
   *                 "url": "https://github.githubassets.com/assets/environment-bootstrap-63ce95f0.js"
   *             },
   *             "children": [
   *                 {
   *                     "callFrame": {
   ...
   *                         "lineNumber": 0,
   *                         "scriptId": "177",
   *                         "url": "https://github.githubassets.com/assets/vendor-0123205f.js"
   *                     },
   *                     "id": 164,
   *                     "selfSize": 16416
   *                 },
...
class V8_EXPORT HeapProfiler {
 public:
  ...
  // <AliOS> changed: begin
  // record last assigned object id and start slice heap dump
  void StartSlicedHeapSnapshot();
  // clear last assigned object id and stop slice heap dump
  void StopSlicedHeapSnapshot();
  // <AliOS> changed: end
