...
// <YUNOS> changed: begin
#if V8_ALIOS_PROJECT_UPDATE > 0
#define V8_ALIOS_VERSION_STRING \
  V8_S(V8_ALIOS_MAJOR_VERSION)  \
  "." V8_S(V8_ALIOS_MINOR_VERSION) "." V8_S(V8_ALIOS_PATCH_LEVEL) \
  "_update" V8_S(V8_ALIOS_PROJECT_UPDATE)
#else
#define V8_ALIOS_VERSION_STRING \
  V8_S(V8_ALIOS_MAJOR_VERSION)  \
  "." V8_S(V8_ALIOS_MINOR_VERSION) "." V8_S(V8_ALIOS_PATCH_LEVEL)
...
#define V8_XTS_VERSION_STRING \
  V8_S(V8_XTS_MAJOR_VERSION) \
  "." V8_S(V8_XTS_MINOR_VERSION) "." V8_S(V8_XTS_PATCH_LEVEL)

#define V8_JSAOT_VERSION_STRING \
  V8_S(V8_JSAOT_MAJOR_VERSION) \
  "." V8_S(V8_JSAOT_MINOR_VERSION) "." V8_S(V8_JSAOT_PATCH_LEVEL)

#define V8_VEX_VERSION_STRING \
  V8_S(V8_VEX_MAJOR_VERSION) \
  "." V8_S(V8_VEX_MINOR_VERSION) "." V8_S(V8_VEX_PATCH_LEVEL)
// <YUNOS> changed: end
